...
func (sc *ServerConn) Read() (*http.Request, error) {
	...
	if lastbody != nil {
		mylog.
			...
			// returned.
			Check(lastbody.Close())
	}

	req = mylog.Check2(http.ReadRequest(r))
	sc.mu.Lock()
	defer sc.mu.Unlock()
...
func (cc *ClientConn) Read(req *http.Request) (resp *http.Response, err error) {
	...
	resp = mylog.Check2(http.ReadResponse(r, req))
	cc.mu.Lock()
	defer cc.mu.Unlock()
